 ...
 * @license GPLv2
 */
/*global ajaxurl, xiphe, namespace */
xiphe.jquery.loaded(function($) {
    namespace('xiphe.relationboxes.classes.Master', (function() {
        function Master() {
            this._disabled = {};
        ...
        Master.prototype = {
            ...
            _enhanceCombobox: function() {
                 ...
                 */
                $('.ui-combobox input').focus(self._setActiveCB);
            ...
            _initAddButton: function() {
                ...
                $('.rb_add')
                    ...
                    .click(function(e) {
                        ...
                        if ($target.length) {
                            self._addexistingCB.call(self, $target);
                        }
                    });
            },


            _addexistingCB: function($target) {
                var self = this,
                    thiz = $target,
                    $prt = thiz.closest('.inside'),
                ...
                $.post(ajaxurl, {
                    ...
                    if (r !== '') {
                        r = eval('('+r+')');
                            ...
                            self._initUnsavedReladtionDelete.call($newLi, relatedOption);
                        }
                    }
                });
            },
            ...
            colorList: function(speed, colors) {
                var i = -1, c;
                $.each($(this).children('li'), function() {
                    c = (i++/2 === Math.floor(i/2) ? colors.alt : colors.def);
    ...
    namespace('xiphe.relationboxes.master', new xiphe.relationboxes.classes.Master());
});